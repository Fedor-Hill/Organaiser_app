...
class QuarterMarkSliverList extends StatelessWidget {
  const QuarterMarkSliverList({super.key, required this.rawNumber});
  ...
  Widget build(BuildContext context) {
    List<Quarter> data = GetIt.I<FinalMarkData>().getQuarterByRawNumber(rawNumber);
